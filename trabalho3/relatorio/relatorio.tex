...
A Tabela~\ref{tab:confusion-summary} resume as matrizes de confusão dos seis descritores individuais. Ela apresenta o número de acertos na diagonal e as confusões mais frequentes observadas no teste. As matrizes de GCH, HOG e da combinação de todos os descritores aparecem a seguir no corpo principal. As demais matrizes completas podem ser consultadas na \hyperref[sec:confusion-matrices]{seção final de matrizes complementares}.
...
\clearpage
\section{Matrizes de Confusão Complementares}
