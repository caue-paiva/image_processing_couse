...
A Tabela~\ref{tab:confusion-summary} resume as matrizes de confusão dos seis descritores individuais. Ela apresenta o número de acertos na diagonal e as confusões mais frequentes observadas no teste. As matrizes de GCH, HOG e da combinação de todos os descritores aparecem a seguir no corpo principal. As demais matrizes completas podem ser consultadas no \hyperref[sec:confusion-matrices]{Apêndice de matrizes complementares}.
...
\clearpage
\phantomsection
\section*{Apêndice: Matrizes de Confusão Complementares}
\addcontentsline{toc}{section}{Apêndice: Matrizes de Confusão Complementares}
\label{sec:confusion-matrices}

Este apêndice reúne as matrizes de confusão completas que não foram exibidas no corpo principal do relatório. As figuras complementam a Tabela~\ref{tab:confusion-summary} e as matrizes já apresentadas para GCH, HOG e para a combinação de todos os descritores, permitindo verificar a distribuição completa de acertos e erros dos demais métodos.
