...
O código está contido em um único arquivo \texttt{trabalho3.py} e utiliza apenas \texttt{numpy}, \texttt{imageio} e \texttt{matplotlib}. Para instalar as dependências:
