...
plt.scatter(x_circ, y_circ, label='com f(t)')
plt.scatter(*circulo_sem_f(np.linspace(0, 50, 1000), freq=1), s=5, label='sem f(t)')
plt.xlim(-2, 2)
plt.ylim(-2, 2)
plt.legend()
plt.show()
...
# ============================================================
# Podemos observar algo interessante quando as frequências do círculo
...
lullaby = np.concatenate([
    make_sound(e4, 2000), make_sound(g4, 2000), make_sound(d4, 2000), make_sound(c4, 2000),
    make_sound(d4, 2000), make_sound(e4, 2000), make_sound(g4, 2000), make_sound(d4, 2000)
])
